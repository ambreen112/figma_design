    ...
    return(
        <section className={style.featured}>
            <div className={style.featured_container}>
                ...
                <Image src={"/desktop.png"} alt="screen" height={300} width={400}/> 
                </div>
                ...
                <Image src={"/statue.png"} alt="scatct of girl" height={300} width={400}/> 
                </div>
                <div className={style.describe_feature}>
                <div className={style. des_featured_title}>Designing Dashboards </div>
                <div className={style.des_featured_date}>
                ...
                <Image src={"/logo.png"} alt="logo" height={300} width={400}/> 
                </div>
                <div className={style.describe_feature}>
                <div className={style. des_featured_title}>Designing Dashboards </div>
                <div className={style.des_featured_date}>
